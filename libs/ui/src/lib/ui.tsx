              ...
              "match": {
                "ctimsButton": {
                  ...
                  onClick: (e: any) => {
                    e.preventDefault();
                    console.log("clicked");
                    this.props.onSpecialButtonClick('hello');
                  },
                },
...
const CtimsForm = (props: any) => {
  ...
  return (
    <div style={containerStyle}>
      ...
      <Dialog header="Dialog" visible={isDialogVisible} style={{width: '50vw'}} onHide={() => setIsDialogVisible(false)}>
        <Form schema={dialogSchema as JSONSchema7}
              templates={{
                ArrayFieldItemTemplate: CtimsArrayFieldItemTemplate,
                ArrayFieldTemplate: CtimsArrayFieldTemplate,
              }}
...
const MemoizedForm = memo(CtimsForm, (prevProps, nextProps) => {
...
export const Ui = memo((props: UiProps) => {
  ...
  return (
    <div style={containerStyle}>
      ...
      {/*      widgets={widgets}*/}
      {/*      onSubmit={(data) => {handleSubmit(data.formData)}} validator={localValidator}/>*/}
      <CtimMatchDialog isDialogVisible={isOpen} dialogSchema={dialogSchema as JSONSchema7} uiSchema={uiSchema}/>
    </div>
  );
});
