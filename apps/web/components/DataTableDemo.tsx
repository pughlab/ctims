...
import styles from './DataTableDemo.module.scss';
...
export const DataTableDemo = () => {
  ...
  useEffect(() => {
    customerService.getCustomers().then(data => { setCustomers(getCustomers(data)); setLoading(false) });
  ...
  return (
    <div className={styles.datatableDocDemo}>
      <div className="card">
