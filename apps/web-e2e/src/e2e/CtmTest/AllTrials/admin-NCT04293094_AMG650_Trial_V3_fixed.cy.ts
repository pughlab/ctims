...
//
//   it('should "Delete" the existing Ctml file as Admin', () => {
//     cy.deleteExistingTrial('NCT04293094 TrialGroupx Admin role', trialGroupName)
//   })
//
...
//
//
//   it.skip('Test Arm 1should enter the values in "Treatment List and Matching criteria modal" for Arm 1 ' , () => {
//     //delete the dose level
//     cy.get('#array-item-list-root_treatment_list_step_0_arm_0_dose_level').children().find('.pi-trash').click()
//
//     cy.clickMultipleFunction(getAddArmPlusIcon(), ctmlTestData.treatment_list.step[0].arm.length - 1)
