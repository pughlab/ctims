import {
  createCTMLButton, ctimsUserTrialGroupxMember,
  getAddArmPlusIcon,
  getAddCriteriaGroup,
  getAddCriteriaList,
  ...
  selectDraftCtmlStatus, selectTrialGroupButton, trialEditorBackButton,
  trialEditorExportCtml,
  trialEditorHeaderButtons,
  trialEditorLeftPanelList,
  trialEditorRadioButtons, trialEditorSave, validateButton, validateOkButton
} from '../../../support/app.po';
...
//************ Arm 1  *****************
  ...
  it('should Validate the CTML Trial Editor', () => {
