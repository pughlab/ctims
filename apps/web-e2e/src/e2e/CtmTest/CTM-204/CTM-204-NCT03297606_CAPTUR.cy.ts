  ...
  it('should enter the values in "Treatment List and Matching criteria modal" for Arm 1', () => {
    ...
    getMultipleArm().each(($input, index) => {
      ...
      if(index === 0) {
        ...
        //save in the middle of matching criteria
  ...
  it('should enter the values in "Treatment List and Matching criteria modal" for Arm 7', () => {
    ...
    getMultipleArm().each(($input, index) => {
      ...
      if(index === 1) {
        ...
        cy.get('body div[class="p-dialog-mask p-dialog-center p-component-overlay p-component-overlay-enter p-dialog-visible p-dialog-draggable p-dialog-resizable"] div[id="pr_id_97"] div[id="pr_id_97_content"] div[class="CtimsMatchDialog_mainContainer__dXMT8"] div[class="MatchingMenuAndForm_matchingMenuAndFormContainer__9m_SO"] div[class="LeftMenuComponent_matchingCriteriaMenuContainer__fe8dz"] div[class="p-tree p-component ctims-tree p-tree-selectable"] ul[role="tree"] li[class="p-treenode"] ul[role="group"] li:nth-child(3) div:nth-child(1)')
          .should('not.have.class','p-highlight')
          .then(() => {
            getSaveMatchingCriteria().click();
          });
