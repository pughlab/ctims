...
declare namespace Cypress {
  ...
  interface Chainable<Subject> {
    ...
    saveAndBackBtn()
    saveOnly()
    clickSaveEditButtonForTrialGroupAdmin(nickNameVal: string, trialGroupName: string)
    ...
    enterAndClinical(testAndConditions: any)
    deleteExistingTrial(trialName: string, trialGroup: string)
