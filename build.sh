...
docker save $CTIMS_WEB_CONTAINER_IMAGE_LOCATION:$GIT_REF -o $CTIMS_WEB_CONTAINER_IMAGE_NAME:$GIT_REF.tar
ctr -n k8s.io image import $CTIMS_WEB_CONTAINER_IMAGE_NAME:$GIT_REF.tar
rm $CTIMS_WEB_CONTAINER_IMAGE_NAME:$GIT_REF.tar
